export class digitalCategoryDB {
    static digital_category = [
        ...
        // },
      {
        image: '<img src=\'assets/images/digital-product/Balance.jpg\' class=\'imgTable\'>',
      },
      {
        image: '<img src=\'assets/images/digital-product/fer a repasser.jpg\' class=\'imgTable\'>',
      },
      {
        image: '<img src=\'assets/images/digital-product/electromenager.jpg\' class=\'imgTable\'>',
      },
    ];
}
